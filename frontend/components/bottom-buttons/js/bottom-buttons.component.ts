...
class BottomButtonsController implements ng.IController {
	...
	public $onDestroy() {
		if (this.escapeFocusModeButton) {
			this.escapeFocusModeButton.parentNode.removeChild(this.escapeFocusModeButton);
		}
	}
	...
	public createIconButton() {
		...
		closeIcon.className = "md-icon angular-material-icons";
		closeIcon.style = "padding: 25%; color: white";
		this.escapeFocusModeButton.appendChild(closeIcon);
